...
### Topic Modeling
Discovering the underlying themes in thousands of patient conversations, symptoms, treatments, diagnosis journeys, and quality of life using unsupervised topic modeling.
...
> 📌 **Note:** The noise cluster (Topic -1) generated by HDBSCAN was explicitly analyzed and documented to ensure academic rigor, explaining why a portion of conversations cannot be confidently assigned to a specific theme.
